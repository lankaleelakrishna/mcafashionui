    ...
    <footer className="bg-card border-t">
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold text-foreground mb-4">MCA Fashion</h3>
            <p className="text-muted-foreground mb-4">
              Curated collections of sarees, lehengas, kurtas and modern tops — crafted with care and tradition.
            </p>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4 text-sm">
              Subscribe to receive new arrivals, style tips, and exclusive offers.
            </p>
